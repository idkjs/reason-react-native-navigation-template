// Original bindings from https://github.com/reason-react-native/async-storage/blob/master/src/ReactNativeAsyncStorage.re with repo name changed to https://github.com/react-native-async-storage/async-storage
